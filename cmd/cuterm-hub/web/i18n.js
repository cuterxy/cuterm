...
var CUTERM_I18N = {
  'en': {
    ...
    'cfg.nodeRemoveFail': 'Failed to remove the node: {error}',
    'cfg.renameNodeTitle': 'Rename node',
    'cfg.nodeRenamePrompt': 'Rename node:',
    'cfg.nodeRenameFail': 'Failed to rename the node: {error}',
    'cfg.enableNodeTitle': 'Show the node on the app page again',
    'cfg.nodeEnableFail': 'Failed to re-enable the node: {error}',
  ...
  'zh-CN': {
    ...
    'cfg.nodeRemoveFail': '删除节点失败：{error}',
    'cfg.renameNodeTitle': '重命名节点',
    'cfg.nodeRenamePrompt': '重命名节点：',
    'cfg.nodeRenameFail': '重命名节点失败：{error}',
    'cfg.enableNodeTitle': '在应用页面重新显示该节点',
    'cfg.nodeEnableFail': '重新启用节点失败：{error}',
