...
// ~/.cuterm/config.json whenever a setting changes via the config page.
...
func configPath() string {
	if home, err := os.UserHomeDir(); err == nil {
		return filepath.Join(home, ".cuterm", "config.json")
	}
	return filepath.Join(os.TempDir(), "cuterm-config.json")
}
